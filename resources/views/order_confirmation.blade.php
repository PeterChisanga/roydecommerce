...
<div class="container" style="height: auto; margin-bottom:150px;">
    <h4 class="text-center" style="color:green;">You have successfully ordered the following items.Click <a href="/myorders">My Orders</a> to view all your orders.</h4>
    <div class="row">
        <div class="col-md-10 mx-auto">
            <?php $totalAmount = 35; //Delivery fee +35?>
            @if(count($orders) > 0)
